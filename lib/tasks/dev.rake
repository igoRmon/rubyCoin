namespace :dev do
    ...
    show_spinner("Cadastrando moedas...") do
      coins = [
                { 
                  ...
                  mining_type: MiningType.find_by(acronyn: 'PoW')
                },
                { 
  ...
  task add_mining_types: :environment do
    show_spinner("Cadastrando tipos de mineração...") do
      mining_types = [
        {description: "Proof of Work", acronyn: "PoW"},
        {description: "Proof of Stake", acronyn: "PoS"},
        {description: "Proof of Capacity", acronyn: "PoC"}
      ]
